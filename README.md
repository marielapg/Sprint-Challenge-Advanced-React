...
class componments make use of ES6 class and extend the Component class in React.
...
is being able to let the users create custom hooks so they can have reusable code
